...
- 加入 Q 版桌宠“达妮娅”，程序状态会触发待机、检查、等待、运行、完成和失败动画及气泡提示。
- 右键达妮娅可诊断管理员权限、游戏窗口、分辨率、模板，以及是否位于无存档的小漂泊者初始界面。
- 右键达妮娅可直接执行拿满奖励、拿满星声和停止任务；由桌宠触发时不再重复弹出开始确认。
- 支持全局快捷键 `Ctrl + Alt + S` 紧急停止当前任务，即使焦点位于游戏窗口也可使用。
- 加入可选粉色“达妮娅主题”，可在设置页与原版简约主题之间切换。
...
- 左键拖动可移动达妮娅，双击可触发互动动作。
- 右键可运行诊断、检测游戏窗口、执行自动任务、停止任务、开关漫游或隐藏桌宠。
- 达妮娅会根据运行状态播放对应动作和气泡，并偶尔称呼你为“漂泊者”主动聊天。
- “达妮娅帮我诊断”会检查权限、窗口比例、截图、配置、模板和正确起始界面，并把详细结果写入日志。

## 程序主题

- 默认继续使用原版简约主题。
- 可在“设置 → 程序主题”中启用粉色“达妮娅主题”，切换后程序会自动重启。
- 主题使用独立压缩资源，额外体积约 49 KB。
...
- `desktop_pet.py`：达妮娅桌宠窗口、动画、气泡和右键菜单。
